...
If you used the IDE to clone, most of them give access to the command line, so use the `ls` command to show that everything is still there.

## Part 2 - Your First C Application
